export type ClaimStatus = "detected" | "submitted" | "approved" | "denied";
...
export const claimsData: Claim[] = [
  ...
  { id: "CLM-002", tracking: "94001118992231000012", carrier: "USPS", issue: "Weight Overcharge", amount: 24.0, status: "submitted", date: "2025-01-27" },
  ...
  { id: "CLM-006", tracking: "94001118992231000025", carrier: "USPS", issue: "Late Delivery", amount: 12.75, status: "denied", date: "2025-01-24" },
  { id: "CLM-007", tracking: "1Z999AA10123456786", carrier: "UPS", issue: "Billing Mistake", amount: 89.0, status: "approved", date: "2025-01-23" },
  { id: "CLM-008", tracking: "794644790134", carrier: "FedEx", issue: "Late Delivery", amount: 37.5, status: "submitted", date: "2025-01-22" },
  { id: "CLM-009", tracking: "1Z999AA10123456787", carrier: "UPS", issue: "Weight Overcharge", amount: 15.6, status: "detected", date: "2025-01-21" },
  { id: "CLM-010", tracking: "94001118992231000038", carrier: "USPS", issue: "Invalid Surcharge", amount: 22.3, status: "approved", date: "2025-01-20" },
  { id: "CLM-011", tracking: "794644790135", carrier: "FedEx", issue: "Duplicate Charge", amount: 44.9, status: "submitted", date: "2025-01-19" },
  { id: "CLM-012", tracking: "1Z999AA10123456788", carrier: "UPS", issue: "Late Delivery", amount: 28.0, status: "approved", date: "2025-01-18" },
  { id: "CLM-013", tracking: "94001118992231000041", carrier: "USPS", issue: "DIM Weight Error", amount: 63.2, status: "detected", date: "2025-01-17" },
  ...
  { id: "CLM-016", tracking: "794644790137", carrier: "FedEx", issue: "Weight Overcharge", amount: 41.0, status: "submitted", date: "2025-01-14" },
  { id: "CLM-017", tracking: "94001118992231000054", carrier: "USPS", issue: "Invalid Surcharge", amount: 8.5, status: "approved", date: "2025-01-13" },
  ...
  { id: "CLM-020", tracking: "94001118992231000067", carrier: "USPS", issue: "Billing Mistake", amount: 33.9, status: "submitted", date: "2025-01-10" },
];
...
export const statusConfig: Record<ClaimStatus, { label: string; className: string }> = {
  ...
  submitted: { label: "Submitted", className: "bg-coral text-primary-foreground border-transparent" },
